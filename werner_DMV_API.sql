...
INSERT INTO Infractions(InfractionID, IType, IFine, LicenseID, LawEnID) VALUES
('I00001','Speeding','19.99', (Select LicenseID FROM Licenses where LicenseID = 'L00001'), (Select LawEnID FROM LawEnforcement where LawEnID = 'LE0001')),
('I00002','no seatbelt','9.99', (Select LicenseID FROM Licenses where LicenseID = 'L00002'), (Select LawEnID FROM LawEnforcement where LawEnID = 'LE0002')),
('I00003','Speeding','19.99', (Select LicenseID FROM Licenses where LicenseID = 'L00003'), (Select LawEnID FROM LawEnforcement where LawEnID = 'LE0003')),
('I00004','Speeding','19.99', (Select LicenseID FROM Licenses where LicenseID = 'L00004'), (Select LawEnID FROM LawEnforcement where LawEnID = 'LE0004')),
('I00005','Speeding','19.99', (Select LicenseID FROM Licenses where LicenseID = 'L00005'), (Select LawEnID FROM LawEnforcement where LawEnID = 'LE0005')),
('I00006','Speeding','19.99', (Select LicenseID FROM Licenses where LicenseID = 'L00006'), (Select LawEnID FROM LawEnforcement where LawEnID = 'LE0006')),
('I00007','Speeding','19.99', (Select LicenseID FROM Licenses where LicenseID = 'L00007'), (Select LawEnID FROM LawEnforcement where LawEnID = 'LE0007')),
('I00008','run red light','59.99', (Select LicenseID FROM Licenses where LicenseID = 'L00008'),(Select LawEnID FROM LawEnforcement where LawEnID = 'LE0008')),
('I00009','Speeding','19.99', (Select LicenseID FROM Licenses where LicenseID = 'L00009'), (Select LawEnID FROM LawEnforcement where LawEnID = 'LE0009')),
('I00010','Speeding','19.99', (Select LicenseID FROM Licenses where LicenseID = 'L00010'), (Select LawEnID FROM LawEnforcement where LawEnID = 'LE0009')),
('I00011','Speeding','19.99', (Select LicenseID FROM Licenses where LicenseID = 'L00010'), (Select LawEnID FROM LawEnforcement where LawEnID = 'LE0010'))
